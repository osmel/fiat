...
$config['sess_cookie_name']		= 'fiat_session';
...
$config['sess_table_name']		= 'fiat_sessions'; //'ci_sessions';
...
| addresses from which CodeIgniter should trust the HTTP_X_FORWARDfiat_FOR
